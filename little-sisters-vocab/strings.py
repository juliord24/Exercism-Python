...
def remove_suffix_ness(word):
    ...
    """
    word_splitted = word.split("ness")
    word_without_suffix = word_splitted[0]
...
def adjective_to_verb(sentence, index):
    ...
    """
    no_dot_sentence = sentence[:-1]
    splitted_sentence = no_dot_sentence.split()
    word_to_verb = splitted_sentence[index]
